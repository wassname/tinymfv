...
![MFV culture map: pure Authority steering against human countries](docs/img/showcase/mfv/map_pca_ipsative.png)

![MFV range plot: foundation emphasis beside pure Authority steering](docs/img/showcase/mfv/range.png)
...
![Humor Styles range plot: human society ranges beside pure Authority steering](docs/img/showcase/humor_styles/range.png)

![Humor Styles culture map: pure Authority steering against human societies](docs/img/showcase/humor_styles/map_pca_ipsative.png)
...
![Big Five range plot: human society ranges beside pure Authority steering](docs/img/showcase/big5/range.png)

![Big Five culture map: pure Authority steering against human societies](docs/img/showcase/big5/map_pca_ipsative.png)
...
![MFQ-2 range plot: human society ranges beside pure Authority steering](docs/img/showcase/mfq2/range.png)
